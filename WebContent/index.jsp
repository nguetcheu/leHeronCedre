...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        ...
        <span class="navbar-text">
          The best restaurant in the Bay of somme according to the michelin guide
        </span>
      </div>
    </div>
  </nav>
  ...
  <section id="about" class="about">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row gy-4">
        <div class="col-lg-7 position-relative about-img" style="background-image: url(resources/img/about.jpg); background-repeat: no-repeat;"
        ...
        <div class="col-lg-5 d-flex align-items-end" data-aos="fade-up" data-aos-delay="300">
          <div class="content ps-0 ps-lg-5">
            <p class="fst-italic">
              the first LeHeronCedre restaurant was created 10 years ago by Benoit and Ange, two cooking and travel enthusiasts.
            </p>
            <ul>
              <li>
